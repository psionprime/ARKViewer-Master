...
{
    public class ArkPlayerDroppedItem : ArkGameDataContainerBase
    {
        ...
        public ArkPlayerDroppedItem(): base()
        {

        }

        public ArkPlayerDroppedItem(IGameObject droppedItem, IGameObject item, ISaveState saveState) 
        {
