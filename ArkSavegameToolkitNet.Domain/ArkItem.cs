...
namespace ArkSavegameToolkitNet.Domain
{
    public class ArkItem : ArkGameDataContainerBase
    {
        ...
        private static readonly ArkName _craftedTribeName = ArkName.Create("CrafterTribeName");
        private static readonly ArkName _craftedPlayerName = ArkName.Create("CrafterCharacterName");
        private static readonly ArkName _craftedSkill = ArkName.Create("CraftedSkillBonus");
        ...
        internal static readonly ArkNameTree _dependencies = new ArkNameTree
        {
            ...
            { _customData, null },
            { _craftedTribeName, null },
            { _craftedPlayerName, null },
            { _craftedSkill, null }
        };
        ...
        public ArkItem(IGameObject item, ISaveState saveState) : this()
        {
            ...
            CraftedTribeName = item.GetPropertyValue<string>(_craftedTribeName);
            CraftedPlayerName = item.GetPropertyValue<string>(_craftedPlayerName);
            CraftedSkillBonus = item.GetPropertyValue<float?>(_craftedSkill);
        ...
        public string CraftedTribeName { get; set; }
        public string CraftedPlayerName { get; set; }
